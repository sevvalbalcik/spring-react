...
public class StaticResourceConfiguration implements WebMvcConfigurer{
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        String path = Paths.get(hoaxifyProperties.getStorage()
        .getRoot()).toAbsolutePath().toString() + "/";
    ...
    CommandLineRunner createStorageDirs(){
        return args -> {
            ...
            createFolder(Paths.get(hoaxifyProperties.getStorage()
            .getRoot(), hoaxifyProperties.getStorage().getProfile()));
        };
    }
