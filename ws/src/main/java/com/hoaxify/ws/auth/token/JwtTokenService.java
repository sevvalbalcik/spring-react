...
public class JwtTokenService implements TokenService{
    ...
    public Token createToken(User user, Credentials creds) {
        ...
        new TokenSubject(user.getId(), user.isActive());
        try {
            String subject = mapper
            .writeValueAsString(tokenSubject);
            String token = Jwts.builder()
            .setSubject(subject).signWith(key).compact();
    ...
    public User verifyToken(String authorizationHeader) {
        ...
        try{
            ...
            var tokenSubject = mapper
            .readValue(subject, TokenSubject.class);
            User user = new User();
